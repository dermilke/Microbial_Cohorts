...
FastSparCC_Server_Function <- function(otu_table_input, output_folder, fastSpar_iterations, bootstrap_num, threads = 4) {
  ...
  writeLines(con = text_file, 
             c(#paste0("arch -x86_64 zsh"),
               paste0("source /Users/felixmilke/Miniforge/miniforge3_x86/etc/profile.d/conda.sh"),
  ...
  system("arch -x86_64 /bin/bash tmp_fastspar_script.sh")
